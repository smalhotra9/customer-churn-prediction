...
3. Model Selection
Multiple machine learning models were evaluated, including Logistic Regression, Decision Trees, KNN, SVM, Random Forest, and XGBoost. Final models were selected based on performance and generalization ability:
-Logistic Regression (baseline)
-Random Forest
-XGBoost
(Other models were excluded from the final pipeline due to comparatively lower performance or lack of improvement)
...
**_Important Result: Logistic Regression achieved the best recall, making it the most suitable model for identifying customers likely to churn._**

📊 Results & Insights
-Customers with low tenure are more likely to churn
-Higher monthly charges correlate with higher churn
-Certain services significantly influence retention
-Model performance comparison helped identify the best predictive approach
